"""
Elimina todos los archivos .png dentro de src/test/data (recursivo).
"""
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Limpia PNGs en src/test/data")
    default_dir = Path(__file__).resolve().parent / "data"
    parser.add_argument(
        "--dir",
        default=str(default_dir),
        help="Directorio base a limpiar (por defecto: src/test/data)",
    )
    parser.add_argument(
        "--dry-run",
        action="store_true",
