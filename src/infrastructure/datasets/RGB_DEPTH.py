"""
Visor simple RGB + Depth en tiempo real usando src/application/viewCamera.py.
...
# Permite ejecutar este archivo directamente: `python src/infrastructure/datasets/RGB_DEPTH.py`
